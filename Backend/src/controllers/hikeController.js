...
export async function createHikeController(req, res) {
    try {
        const { image, title, description, duration, level, max_participants, price, location, is_active } = req.body;
        const result = await createHike(image, title, description, duration, level, max_participants, price, location, is_active);
...
export async function UpHike(req, res) {
    try {
        const id = req.params.id;
        const { image, title, description, duration, level, max_participants, price, location, is_active } = req.body;
        const hike = await updateHike(id, image, title, description, duration, level, max_participants, price, location, is_active);      
